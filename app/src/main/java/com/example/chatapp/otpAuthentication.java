...
public class otpAuthentication extends AppCompatActivity {
    ...
    ProgressBar mprogressbaroftopath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mprogressbaroftopath=findViewById(R.id.progressbarofpauth);
        ...
        mverifyotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Enter your OTP ifrst",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    mprogressbaroftopath.setVisibility(View.VISIBLE);
    ...
    private void signInwithPhoneAuthCredential(PhoneAuthCredential credential)
    {
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                {
                    mprogressbaroftopath.setVisibility(View.INVISIBLE);
